class AppStrings {
  ...
  static const String PredictionVieweError ='⚠️ Error fetching prediction:';
  static const String PredictionViewNoForcast ='🌧️ No forecast data available.';
  static const String CheckButton ='🔍 Click the check icon to see your prediction!';
  static const String SubTitlePrediction ='Your prediction will be displayed in a quick alert ✨';
  static const String NoFavorites ='No favorite cities yet! ⭐';
